        ...
        <div class="space-y-8 animate-fadeInUp">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:space-x-4 pt-4">
            ...
            <div class="flex flex-wrap gap-2 sm:gap-3">
              <a
                href="https://scholar.google.com/citations?user=W_qzYZ0AAAAJ"
                target="_blank"
              ...
              >
                <img src="/images/google-scholar.svg" alt="Google Scholar" class="w-5 h-5 opacity-70 hover:opacity-100" :style="{ filter: 'var(--theme-invert)' }" />
              </a>
              <a
                href="https://github.com/eric11eca"
                target="_blank"
                class="p-3 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-[var(--theme-surface-container-high)] hover:bg-[var(--theme-surface-container-higher)] transition-colors duration-200"
                title="GitHub"
              >
                <svg class="w-5 h-5 text-[var(--theme-on-surface-variant)] hover:text-[var(--theme-on-surface)]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://twitter.com/eric_zemingchen"
                target="_blank"
                class="p-3 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-[var(--theme-surface-container-high)] hover:bg-[var(--theme-surface-container-higher)] transition-colors duration-200"
                title="Twitter"
              >
              ...
              <a
                href="https://linkedin.com/in/zeming-chen-bb951b134"
                target="_blank"
                class="p-3 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-[var(--theme-surface-container-high)] hover:bg-[var(--theme-surface-container-higher)] transition-colors duration-200"
                title="LinkedIn"
              >
              ...
              <a
                href="https://www.semanticscholar.org/author/Zeming-Chen/2109441874"
                target="_blank"
                class="p-3 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-[var(--theme-surface-container-high)] hover:bg-[var(--theme-surface-container-higher)] transition-colors duration-200"
                title="Semantic Scholar"
              >
                <img src="/images/semantic-scholar.svg" alt="Semantic Scholar" class="w-5 h-5 opacity-70 hover:opacity-100" :style="{ filter: 'var(--theme-invert)' }" />
              </a>
              <a
                href="https://huggingface.co/eric11eca"
                target="_blank"
                class="p-3 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-full bg-[var(--theme-surface-container-high)] hover:bg-[var(--theme-surface-container-higher)] transition-colors duration-200"
                title="Hugging Face"
              >
                <img src="/images/hugging-face.svg" alt="Hugging Face" class="w-5 h-5 opacity-70 hover:opacity-100" :style="{ filter: 'var(--theme-invert)' }" />
              </a>
            </div>
          </div>
